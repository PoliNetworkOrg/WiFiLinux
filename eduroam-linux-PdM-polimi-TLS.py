...
Config.instname = "Politecnico di Milano"
Config.profilename = "polimi-TLS"
Config.url = "https://www.connectandgo.polimi.it/en/"
Config.email = "your local eduroam® support"
Config.title = "eduroam CAT"
Config.server_match = "wifi.polimi.it"
Config.eap_outer = "TLS"
Config.eap_inner = ""
...
Config.user_realm = "polimi.it"
Config.ssids = ['eduroam', 'polimi-protected']
Config.del_ssids = []
Config.servers = ['DNS:wifi.polimi.it']
